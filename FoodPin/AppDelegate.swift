    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        container.loadPersistentStores(completionHandler: { (storeDescription,
            ...
            if let error = error as NSError? {
                // Replace this implementation with code to handle the error appropriately.// fatalError() causes the application to generate a crash log and
                //terminate. You should not use this function in a shipping application,althoughit may be useful during development.
                /*
